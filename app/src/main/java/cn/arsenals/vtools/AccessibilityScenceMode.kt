...
import cn.arsenals.scene_mode.AppSwitchHandler
import cn.arsenals.scene_mode.AutoClickInstall
import cn.arsenals.scene_mode.AutoSkipAd
...
public class AccessibilityScenceMode : AccessibilityService(), IEventReceiver {
    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent) {
        ...
        */
        ...
        if (packageName != null) {
            when {
                packageName == "cn.arsenals.gesture" || packageName == "cn.arsenals.filter" -> {
                    return
                }
                /*
                ...
                */
                // packageName == "cn.arsenals.tunearsenals" -> return
        ...
        if (effectiveWindows.isNotEmpty()) {
            try {
                ...
                for (window in effectiveWindows) {
                    ...
                    if (wp == null || wp == "android" || wp == "com.android.systemui" || wp == "com.miui.freeform" || wp == "cn.arsenals.gesture" || wp == "cn.arsenals.filter" || wp == "com.android.permissioncontroller") {
                        continue
                    }
                    */
                    if (isLandscape) {
