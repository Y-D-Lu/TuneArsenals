package cn.arsenals.tunearsenals.addin
...
import cn.arsenals.tunearsenals.services.CompileService
...
class DexCompileAddin(private var context: ActivityBase) : AddinBase(context) {
    ...
    private fun run2() {
        ...
        view.findViewById<View>(R.id.mode_speed_profile).setOnClickListener {
            dialog.dismiss()
            triggerCompile(context.getString(R.string.tunearsenals_speed_profile_compile))
        }
        view.findViewById<View>(R.id.mode_speed).setOnClickListener {
            dialog.dismiss()
            triggerCompile(context.getString(R.string.tunearsenals_speed_compile))
        }
        view.findViewById<View>(R.id.mode_everything).setOnClickListener {
            dialog.dismiss()
            triggerCompile(context.getString(R.string.tunearsenals_everything_compile))
        }
        view.findViewById<View>(R.id.mode_reset).setOnClickListener {
            dialog.dismiss()
            triggerCompile(context.getString(R.string.tunearsenals_reset_compile))
        }
