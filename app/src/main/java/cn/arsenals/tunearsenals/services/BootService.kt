...
import cn.arsenals.common.shared.RawText
...
class BootService : IntentService("tunearsenals-boot") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        */
        ...
        val r = PropsUtils.getProp("tunearsenals.boot")
        if (!r.isEmpty()) {
            isFirstBoot = false
            bootCancel = true
    ...
    private fun autoBoot() {
        ...
        if (!keepShell.doCmdSync("getprop tunearsenals.swap.controller").equals("magisk")) {
