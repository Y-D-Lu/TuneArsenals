package cn.arsenals.tunearsenals.services
 ...
 * 后台编译应用
 */
class CompileService : IntentService("tunearsenals-compile") {
    companion object {
        var compiling = false
    }
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        */
        ...
        if (intent != null) {
            if (intent.action == getString(R.string.tunearsenals_speed_compile)) {
                compile_method = "speed"
            } else if (intent.action == getString(R.string.tunearsenals_speed_profile_compile)) {
                compile_method = "speed-profile"
            } else if (intent.action == getString(R.string.tunearsenals_everything_compile)) {
                compile_method = "everything"
            } else if (intent.action == getString(R.string.tunearsenals_reset_compile)) {
        ...
        if (compile_method == "reset") {
            ...
            for (packageName in packageNames) {
                if (true) {
                    ...
                    cmdBuilder.append("am broadcast -n cn.arsenals.tunearsenals/cn.arsenals.tunearsenals.ReceiverCompileState --ei current $current --ei total $total --es packageName $packageName\n")
            ...
            cmdBuilder.append("am broadcast -n cn.arsenals.tunearsenals/cn.arsenals.tunearsenals.ReceiverCompileState --ei current $total --ei total $total --es packageName OK\n")
