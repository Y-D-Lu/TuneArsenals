...
class ActivityAddinOnline : ActivityBase() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (this.intent.extras != null) {
            ...
            if (extraData?.containsKey("url") == true) {
                tunearsenals_online.loadUrl(extraData.getString("url")!!)
            } else {
                tunearsenals_online.loadUrl("https://helloklf.github.io/tunearsenals-online.html#/scripts")
            }
        } else {
            tunearsenals_online.loadUrl("https://helloklf.github.io/tunearsenals-online.html#/scripts")
        }
        ...
        // 处理alert、confirm
        tunearsenals_online.webChromeClient = object : WebChromeClient() {
        ...
        tunearsenals_online.setWebViewClient(object : WebViewClient() {
            ...
            private fun tryGetPowercfg(view: WebView?, url: String?): Boolean {
                if (url != null && view != null) {
                    // v1
                    // https://github.com/yc9559/cpufreq-interactive-opt/blob/master/tunearsenals-powercfg/20180603/sd_845/powercfg.apk 源码地址
                    // https://github.com/yc9559/cpufreq-interactive-opt/raw/master/tunearsenals-powercfg/20180603/sd_845/powercfg.apk 点击raw指向的链接
                    // https://raw.githubusercontent.com/yc9559/cpufreq-interactive-opt/master/tunearsenals-powercfg/20180603/sd_845/powercfg.apk 然后重定向到具体文件
    ...
    override fun onKeyDown(keyCode: Int, event: KeyEvent?): Boolean {
        if (keyCode == KeyEvent.KEYCODE_BACK && tunearsenals_online.canGoBack()) {
            tunearsenals_online.goBack()
            return true
        } else {
    ...
    override fun onDestroy() {
        tunearsenals_online.clearCache(true)
        tunearsenals_online.removeAllViews()
        tunearsenals_online.destroy()
        super.onDestroy()
    }
