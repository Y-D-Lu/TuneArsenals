...
class DialogAppCGroupMem(var context: Activity, val current: String?, val iResultCallback: IResultCallback) {
    ...
    fun show() {
        val view = context.layoutInflater.inflate(R.layout.dialog_tunearsenals_app_cgroup, null)
